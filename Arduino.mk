...
ARDUINO_CORE_PATH = $(ARDUINO_DIR)/hardware/arduino/$(ARDUINO_MCU)/cores/arduino
ARDUINO_VAR_PATH  = $(ARDUINO_DIR)/hardware/arduino/$(ARDUINO_MCU)/variants
...
ifndef BOARDS_TXT
BOARDS_TXT  = $(ARDUINO_DIR)/hardware/arduino/$(ARDUINO_MCU)/boards.txt
endif
...
# General arguments
SYS_LIBS      = $(patsubst %,$(ARDUINO_LIB_PATH)/%/src,$(ARDUINO_LIBS))
